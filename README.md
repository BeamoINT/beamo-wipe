...
The ISO lands in `dist/beamo-wipe-0.2.6-amd64.iso`. If Docker or live-build
...
sudo dd if=dist/beamo-wipe-0.2.6-amd64.iso of=/dev/sdX bs=4M status=progress conv=fsync
