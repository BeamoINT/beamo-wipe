...
The ISO lands in `dist/beamo-wipe-0.2.7-amd64.iso`. If Docker or live-build
...
qemu-system-x86_64 -m 2048 -enable-kvm \
  -cdrom dist/beamo-wipe-0.2.7-amd64.iso \
...
sudo dd if=dist/beamo-wipe-0.2.7-amd64.iso of=/dev/sdX bs=4M status=progress conv=fsync
