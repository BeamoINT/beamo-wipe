...
def _export_pairs() -> list[tuple[str, str]]:
    ...
    return [
        ...
        (E.USB_LAYOUT_MALFORMED, "X-LYM"),
        (E.USB_LAYOUT_AMBIGUOUS, "X-LYA"),
        (E.USB_NEED_ONE_VOLUME, "X-VSNG"),
        (E.USB_LAYOUT_UNSUPPORTED, "X-LYU"),
        (E.USB_PARTITION_ORPHAN, "X-KID"),
        (E.USB_VOLUME_PATH_UNSUPPORTED, "X-VPTH"),
        (E.USB_VOLUME_WRITABLE, "X-VWRT"),
        (E.USB_VOLUME_SMALL, "X-VSML"),
        ...
        (E.DISK_IDENTITY_CHANGED, "X-DSIG"),
        ...
        (E.RECEIPT_FAILURE_INVALID, "X-RINV"),
